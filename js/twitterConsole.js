...
/******************************
********** intercactivity 88888?
***********************************/
  $( "#nav" ).click(function() {
    console.log( "Handler for .click() called." );
    // console.log(twitterFetcher.parseTweets());
    // twitterFetcher.getAllTweets(tweetArr);
    var tArray = twitterFetcher.getAllTweets();
    var dArray = twitterFetcher.getAllDTweets();
    var uArray = twitterFetcher.getAllUsers();
    //// console.log(twitterFetcher.getAllTweets());
    sendAllTweets(tArray, dArray, uArray);

  });


  function reDoSearch(){
    twitterFetcher.clearTweetArrays();
    twitterFetcher.fetch(config4);
   
  }

  function loadTweetsGun(){
  ...
  function sendAllTweets(tArray, dArray, uArray){

    /// last to first
    /*
    for(var i=tArray.length-1; i >0 ; i--){
      sendTweetToSketch(tArray[i], dArray[i]);
      
    }
    */

    for(var i=0; i <tArray.length ; i++){
      console.log("WHAT IS THE ARRAY LENGTH: " + tArray.length);
      sendTweetToSketch(tArray[i], dArray[i], uArray[i]);
...
// retweets.
var config4 = {
  "id": '826258531657543680', // 784137556476567552',
  "domId": 'example4',
  "maxTweets": 100,
  "enableLinks": false,
  "showUser": true,
...
var config5 = {
  "id": '825985566785228800', // 345690956013633536',
  "domId": '',
  "maxTweets": 135,
  "enableLinks": true,
  "showUser": true,
...
function populateTpl(tweets){
  ...
  try{
    ...
    console.log("error writing html " + e);
  }
